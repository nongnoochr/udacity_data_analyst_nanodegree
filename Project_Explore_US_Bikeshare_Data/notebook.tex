...
\textbf{Answer}: 1. What time of the day that has the most number of
rentals? 2. How long, in average, is the trip (rent-\textgreater{}
return)? 3. Number of rentals in each area. 4. Users: Does the
rent-rental stations cover the whole city? How far apart? 5. Users: What
is a pricing model? How much I need to pay per trip based on distance?
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
        ...
        \PY{k}{def} \PY{n+nf}{loadCSVData}\PY{p}{(}\PY{n}{fileName}\PY{p}{)}\PY{p}{:}
            \PY{n}{dataList} \PY{o}{=} \PY{p}{[}\PY{p}{]}\PY{p}{;}
            \PY{n}{fullPath} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{fileName}\PY{p}{)}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{fullPath}\PY{p}{)} \PY{k}{as} \PY{n}{csvDataFile}\PY{p}{:}
                \PY{n}{csvReader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{csvDataFile}\PY{p}{)}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{csvReader}\PY{p}{:}
                    \PY{n}{dataList}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{)}
            \PY{k}{return} \PY{n}{dataList}\PY{p}{;}
            
        \PY{c+c1}{\PYZsh{} Chicaco}
        \PY{n}{dataChicaco} \PY{o}{=} \PY{n}{loadCSVData}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago\PYZhy{}Divvy\PYZhy{}2016.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{n}{dataNewYork} \PY{o}{=} \PY{n}{loadCSVData}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC\PYZhy{}CitiBike\PYZhy{}2016.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{n}{dataWashington} \PY{o}{=} \PY{n}{loadCSVData}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington\PYZhy{}CapitalBikeshare\PYZhy{}2016.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
        
                      
        \PY{c+c1}{\PYZsh{} print(dataChicaco[1]);}
        \PY{c+c1}{\PYZsh{} print(dataNewYork[1]);}
        \PY{c+c1}{\PYZsh{} print(dataWashington[1]);}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{n}{first\PYZus{}trip} \PY{o}{=} \PY{n+nb}{next}\PY{p}{(}\PY{n}{trip\PYZus{}reader}\PY{p}{)}\PY{p}{;}
                ...
                \PY{n}{pprint}\PY{p}{(}\PY{n}{first\PYZus{}trip}\PY{p}{)}\PY{p}{;}
...
below to address each of the cleaning tasks described above.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{def} \PY{n+nf}{get\PYZus{}time\PYZus{}for}\PY{p}{(}\PY{n}{timeStr}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Get a datetime format for the specified city}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             
             \PY{n}{timeFormat} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} NYC includes seconds in the datetime format}
                 \PY{n}{timeFormat} \PY{o}{+}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{timeFormat} \PY{o}{+}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             
             \PY{k}{return} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{timeStr}\PY{p}{,} \PY{n}{timeFormat}\PY{p}{)}\PY{p}{;}
             
             
         \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{duration} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{;}
             
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 
                 \PY{c+c1}{\PYZsh{} Duration will be calculated by delta of starttime and stoptime}
                 \PY{n}{startTimeStr} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{;}
                 \PY{n}{stopTimeStr} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{stoptime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{;}
         
                 \PY{n}{startTime} \PY{o}{=} \PY{n}{get\PYZus{}time\PYZus{}for}\PY{p}{(}\PY{n}{startTimeStr}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
                 \PY{n}{stopTime} \PY{o}{=} \PY{n}{get\PYZus{}time\PYZus{}for}\PY{p}{(}\PY{n}{stopTimeStr}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
         
                 \PY{n}{deltaTime} \PY{o}{=} \PY{n}{stopTime} \PY{o}{\PYZhy{}} \PY{n}{startTime}\PY{p}{;}
         
                 \PY{n}{duration} \PY{o}{=} \PY{n}{deltaTime}\PY{o}{.}\PY{n}{total\PYZus{}seconds}\PY{p}{(}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60}\PY{p}{;}
             
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60}\PY{p}{;}
                 
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60000}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{duration} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{;}
            \PY{n}{startTimeStr} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
            
            \PY{k}{if} \PY{n}{city} \PY{o+ow}{in} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{:}
                \PY{n}{startTimeStr} \PY{o}{+}\PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{;}
                
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{startTimeStr} \PY{o}{+}\PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{;}
            
            
            \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
            \PY{n}{startTime} \PY{o}{=} \PY{n}{get\PYZus{}time\PYZus{}for}\PY{p}{(}\PY{n}{startTimeStr}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
            
            \PY{n}{month} \PY{o}{=} \PY{n}{startTime}\PY{o}{.}\PY{n}{month}\PY{p}{;}
            \PY{n}{hour} \PY{o}{=} \PY{n}{startTime}\PY{o}{.}\PY{n}{hour}\PY{p}{;}
            
            \PY{c+c1}{\PYZsh{} Get a string of weekday}
            \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{startTime}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{fieldName} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             
             \PY{c+c1}{\PYZsh{} Get a key name for a user type}
             \PY{k}{if} \PY{n}{city} \PY{o+ow}{in} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{:}
                 \PY{n}{fieldName} \PY{o}{+}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{usertype}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{fieldName} \PY{o}{+}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Member Type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
                 
             \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{n}{fieldName}\PY{p}{]}\PY{p}{;}
             
             \PY{c+c1}{\PYZsh{} Washington uses different values to store the user type}
             \PY{c+c1}{\PYZsh{} and we need to update it to match what are used in other}
             \PY{c+c1}{\PYZsh{} data sets}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{k}{if} \PY{n}{user\PYZus{}type} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                     \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
                 \PY{k}{else}\PY{p}{:}
                     \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
             
             \PY{k}{return} \PY{n}{user\PYZus{}type}\PY{p}{;}
...
be consistent with the example file.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k}{def} \PY{n+nf}{condense\PYZus{}data}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{n}{out\PYZus{}file}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{trip\PYZus{}reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}\PY{p}{;}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}
                     ...
                     \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{} Get duration}
                     \PY{n}{duration} \PY{o}{=} \PY{n}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
                     
                     \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{} Get createdOn info}
                     \PY{n}{month}\PY{p}{,} \PY{n}{hour}\PY{p}{,} \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
                     
                     \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{} Get user type}
                     \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{;}
                     
                     \PY{n}{new\PYZus{}point}\PY{o}{.}\PY{n}{update}\PY{p}{(}\PY{p}{\PYZob{}}
                         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{duration}\PY{p}{,}
                         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{month}\PY{p}{,} 
                         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{hour}\PY{p}{,} 
                         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{day\PYZus{}of\PYZus{}week}\PY{p}{,} 
                         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{user\PYZus{}type}
                     ...
                     \PY{n}{trip\PYZus{}writer}\PY{o}{.}\PY{n}{writerow}\PY{p}{(}\PY{n}{new\PYZus{}point}\PY{p}{)}\PY{p}{;}
                     
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
         ...
         \PY{c+c1}{\PYZsh{}     print\PYZus{}first\PYZus{}point(filenames[\PYZsq{}out\PYZus{}file\PYZsq{}])}
\end{Verbatim}
...
\textbf{Answer}: 1. `NYC' has the highest number of trips. 2. `NYC' has
the highest proportion of trips made by subscribers. 3. `Chicago' has
the highest proportion of trips made by short-term customers.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} the function on the cleaned data files you created from Question 3.      \PYZsh{}\PYZsh{}}
         
         \PY{k}{def} \PY{n+nf}{printData}\PY{p}{(}\PY{n}{dataPath}\PY{p}{)}\PY{p}{:}
             \PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{dataPath}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{n\PYZus{}total}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{ trips maded from subscribers: }\PY{l+s+si}{\PYZob{}:.2f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}total}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{ trips maded from customers: }\PY{l+s+si}{\PYZob{}:.2f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{n\PYZus{}customers}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}total}\PY{p}{)}\PY{p}{)}\PY{p}{;}
         
         \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         \PY{n}{mapData} \PY{o}{=} \PY{p}{\PYZob{}}
             \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
         ...
         \PY{k}{for} \PY{n}{key}\PY{p}{,}\PY{n}{dataPath} \PY{o+ow}{in} \PY{n}{mapData}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{* }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n}{printData}\PY{p}{(}\PY{n}{dataPath}\PY{p}{)}\PY{p}{;}
...
* NYC
Total : 276798
\% trips maded from subscribers: 88.84
\% trips maded from customers: 11.16


* Chicago
Total : 72131
\% trips maded from subscribers: 76.23
\% trips maded from customers: 23.77


* Washington
Total : 66326
\% trips maded from subscribers: 78.03
\% trips maded from customers: 21.97
...
\textbf{Answer}: 1. The average trip length for each city: ``NYC'': 16.0
minutes, ``Chicago'': 16.6 minutes, ``Washington'': 18.9 minutes,
...
\tightlist
\item
  Proportion of rides made in each city that are longer that 30 minutes:
  ``NYC'': 7.5\%, ``Chicago'': 8.3\%, ``Washington'': 10.8\%,
\end{enumerate}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{getTripInfo}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads in a file with trip data and reports the number of}
         \PY{l+s+sd}{    trips made by subscribers, customers, and total overall.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{tripData} \PY{o}{=} \PY{p}{[}\PY{p}{]}\PY{p}{;}
                 
                 \PY{c+c1}{\PYZsh{} tally up ride types}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{tripData}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{;}
                 
                 \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} compute average duration}
                 \PY{n}{numTrips} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{tripData}\PY{p}{)}\PY{p}{)}\PY{p}{;}
                 \PY{n}{avgDuration} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{tripData}\PY{p}{)} \PY{o}{/} \PY{n}{numTrips}\PY{p}{;}
                 
                 \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} compute \PYZpc{} of trips that take longer that 30 mins}
                 \PY{n}{cnt\PYZus{}LongTrip} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{;}
                 
                 \PY{k}{for} \PY{n}{curDur} \PY{o+ow}{in} \PY{n}{tripData}\PY{p}{:}
                     
                     \PY{k}{if} \PY{n}{curDur} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{:}
                         \PY{n}{cnt\PYZus{}LongTrip} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}\PY{p}{;}
                         
                 \PY{n}{ratioLongTrip} \PY{o}{=} \PY{p}{(}\PY{n}{cnt\PYZus{}LongTrip} \PY{o}{/} \PY{n}{numTrips}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100}\PY{p}{;}
                    
                 \PY{k}{return}\PY{p}{(}\PY{n}{avgDuration}\PY{p}{,} \PY{n}{ratioLongTrip}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n}{key}\PY{p}{,}\PY{n}{dataPath} \PY{o+ow}{in} \PY{n}{mapData}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{* }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n}{avgDuration}\PY{p}{,} \PY{n}{ratioLongTrip} \PY{o}{=} \PY{n}{getTripInfo}\PY{p}{(}\PY{n}{dataPath}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average duration: }\PY{l+s+si}{\PYZob{}:.1f\PYZcb{}}\PY{l+s+s1}{ minutes}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{avgDuration}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{} lo}\PY{l+s+s1}{ng trip: }\PY{l+s+si}{\PYZob{}:.1f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{ratioLongTrip}\PY{p}{)}\PY{p}{)}\PY{p}{;}   
...
For all cities, the Customer trip duration takes much longer than the
Subscriber trip duration, especially in Washington where the averarage
Customer trip duration is 41 minutes.

Additionally, the average Customer trip duration of all cities is above
30 minutes where the average Subscriber trip duration is between 12 to
14 minutes.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{findAverage}\PY{p}{(}\PY{n}{data}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Return an average value of the specified list data}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{return} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{data}\PY{p}{)} \PY{o}{/} \PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{data}\PY{p}{)}\PY{p}{)}\PY{p}{;}
         
         \PY{k}{def} \PY{n+nf}{getAvgDurationForType}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function gets avareage duration for each type of customers}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} set up csv reader object}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 
                 \PY{n}{dataSubscribers} \PY{o}{=} \PY{p}{[}\PY{p}{]}\PY{p}{;}
                 \PY{n}{dataCustomers} \PY{o}{=} \PY{p}{[}\PY{p}{]}\PY{p}{;}
                 
                 \PY{c+c1}{\PYZsh{} tally up ride types}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     
                     \PY{n}{curDuration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{;}
                     
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{dataSubscribers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{curDuration}\PY{p}{)}\PY{p}{;}
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{dataCustomers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{curDuration}\PY{p}{)}\PY{p}{;}
                 
                 \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} compute average duration}
                 \PY{n}{avgSubscribers} \PY{o}{=} \PY{n}{findAverage}\PY{p}{(}\PY{n}{dataSubscribers}\PY{p}{)}\PY{p}{;}
                 \PY{n}{avgCustomers} \PY{o}{=} \PY{n}{findAverage}\PY{p}{(}\PY{n}{dataCustomers}\PY{p}{)}\PY{p}{;}
                 
                 \PY{k}{return}\PY{p}{(}\PY{n}{avgSubscribers}\PY{p}{,} \PY{n}{avgCustomers}\PY{p}{)}
             
         \PY{c+c1}{\PYZsh{} data\PYZus{}file = \PYZsq{}./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv\PYZsq{}}
         \PY{c+c1}{\PYZsh{} print(getAvgDurationForType(data\PYZus{}file))}
         ...
         \PY{k}{for} \PY{n}{key}\PY{p}{,}\PY{n}{dataPath} \PY{o+ow}{in} \PY{n}{mapData}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{* }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n}{avgSubscribers}\PY{p}{,} \PY{n}{avgCustomers} \PY{o}{=} \PY{n}{getAvgDurationForType}\PY{p}{(}\PY{n}{dataPath}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Avg Subscribers: }\PY{l+s+si}{\PYZob{}:.1f\PYZcb{}}\PY{l+s+s1}{ minutes}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{avgSubscribers}\PY{p}{)}\PY{p}{)}\PY{p}{;}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Avg Customers: }\PY{l+s+si}{\PYZob{}:.1f\PYZcb{}}\PY{l+s+s1}{ minutes}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{avgCustomers}\PY{p}{)}\PY{p}{)}\PY{p}{;}   
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
* NYC
Avg Subscribers: 13.7 minutes
Avg Customers: 32.8 minutes


* Chicago
Avg Subscribers: 12.1 minutes
Avg Customers: 31.0 minutes


* Washington
Avg Subscribers: 12.5 minutes
Avg Customers: 41.7 minutes
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} and then use pyplot functions to generate a histogram of trip times.     \PYZsh{}\PYZsh{}}
         \PY{k+kn}{import} \PY{n+nn}{csv}\PY{p}{;}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         
         \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline 
         
         \PY{k}{def} \PY{n+nf}{getDurationData}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function gets avareage duration for each type of customers}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     ...
                     \PY{n}{curDuration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{;}
                     \PY{n}{data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{curDuration}\PY{p}{)}\PY{p}{;}
                     
                 \PY{k}{return} \PY{n}{data}\PY{p}{;}
         
         \PY{c+c1}{\PYZsh{} data\PYZus{}file = \PYZsq{}./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv\PYZsq{}}
         \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
         \PY{n}{data} \PY{o}{=} \PY{n}{getDurationData}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{;}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{n+nb}{min}\PY{p}{(}\PY{n}{data}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{]}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
Distribution of the Subscribers: The peak is in a range {[}5, 10{]}. The
distribution is skewed to the right which shows that most subscribers
spend less time for a single trip.

Distribution of the Customers: The peak is in a range {[}15,20{]}. The
distribution is also skewed to the right but it is more spanned than the
distribution of the subscribers.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{getDataByType}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function gets avareage duration for each type of customers}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{return}\PY{p}{(}\PY{n}{dataSubscribers}\PY{p}{,} \PY{n}{dataCustomers}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} data\PYZus{}file = \PYZsq{}./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv\PYZsq{}}
         \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
         \PY{n}{dataSubscribers}\PY{p}{,} \PY{n}{dataCustomers} \PY{o}{=} \PY{n}{getDataByType}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{;}
         
         \PY{c+c1}{\PYZsh{} Subscribers}
         \PY{n}{maxVal} \PY{o}{=} \PY{l+m+mi}{75}\PY{p}{;}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{dataSubscribers}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{n+nb}{min}\PY{p}{(}\PY{n}{dataSubscribers}\PY{p}{)}\PY{p}{,} \PY{n}{maxVal}\PY{p}{]}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{maxVal}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations (Subscribers)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Customers}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{dataCustomers}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{n+nb}{min}\PY{p}{(}\PY{n}{dataCustomers}\PY{p}{)}\PY{p}{,} \PY{n}{maxVal}\PY{p}{]}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{maxVal}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations (Customers)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
visualization below!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{c+c1}{\PYZsh{} Is the pattern of ridership different on the weekends versus weekdays? }
         \PY{c+c1}{\PYZsh{} On what days are Subscribers most likely to use the system? }
         \PY{c+c1}{\PYZsh{} What about Customers? }
         \PY{c+c1}{\PYZsh{} Does the average duration of rides change depending on the day of the week?}
         ...
         \PY{k}{def} \PY{n+nf}{getDayDataByType}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function gets avareage duration for each type of customers}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{dataSubscribers} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{;}
                 \PY{n}{dataCustomers} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{;}
                 
                 \PY{n}{avgSubscribers} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{;}
                 \PY{n}{avgCustomers} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{;}
                 
                 \PY{n}{durationSubscribers} \PY{o}{=} \PY{p}{\PYZob{}}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wednesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thursday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Friday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Saturday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sunday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}
                 \PY{p}{\PYZcb{}}\PY{p}{;}
                 
                 \PY{n}{durationCustomers} \PY{o}{=} \PY{p}{\PYZob{}}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wednesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thursday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{p}{]}\PY{p}{,}
                 ...
                 \PY{n}{mapDayIndex} \PY{o}{=} \PY{p}{\PYZob{}}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{0}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wednesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{2}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thursday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{3}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Friday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{4}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Saturday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{5}\PY{p}{,}
                     \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sunday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{6}
                 \PY{p}{\PYZcb{}}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     ...
                     \PY{n}{curDuration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{;}
                     \PY{n}{curDay} \PY{o}{=} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{;}
                     
                     \PY{n}{index} \PY{o}{=} \PY{n}{mapDayIndex}\PY{p}{[}\PY{n}{curDay}\PY{p}{]}\PY{p}{;}
                     
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{dataSubscribers}\PY{p}{[}\PY{n}{index}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}\PY{p}{;}
                         \PY{n}{durationSubscribers}\PY{p}{[}\PY{n}{curDay}\PY{p}{]}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{curDuration}\PY{p}{)}\PY{p}{;}
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{dataCustomers}\PY{p}{[}\PY{n}{index}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}\PY{p}{;}
                         \PY{n}{durationCustomers}\PY{p}{[}\PY{n}{curDay}\PY{p}{]}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{curDuration}\PY{p}{)}\PY{p}{;}
                     
                 \PY{k}{for} \PY{n}{curDay}\PY{p}{,} \PY{n}{dataDay} \PY{o+ow}{in} \PY{n}{durationSubscribers}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
                     \PY{n}{index} \PY{o}{=} \PY{n}{mapDayIndex}\PY{p}{[}\PY{n}{curDay}\PY{p}{]}\PY{p}{;}
                     \PY{n}{avgSubscribers}\PY{p}{[}\PY{n}{index}\PY{p}{]} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{dataDay}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{dataDay}\PY{p}{)}\PY{p}{)}\PY{p}{;}
                 
                 \PY{k}{for} \PY{n}{curDay}\PY{p}{,} \PY{n}{dataDay} \PY{o+ow}{in} \PY{n}{durationCustomers}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
                     \PY{n}{index} \PY{o}{=} \PY{n}{mapDayIndex}\PY{p}{[}\PY{n}{curDay}\PY{p}{]}\PY{p}{;}
                     \PY{n}{avgCustomers}\PY{p}{[}\PY{n}{index}\PY{p}{]} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{dataDay}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{dataDay}\PY{p}{)}\PY{p}{)}\PY{p}{;}
                     
                 \PY{k}{return}\PY{p}{(}\PY{n}{dataSubscribers}\PY{p}{,} \PY{n}{dataCustomers}\PY{p}{,} \PY{n}{avgSubscribers}\PY{p}{,} \PY{n}{avgCustomers}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} data\PYZus{}file = \PYZsq{}./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv\PYZsq{}}
         \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{getDayDataByType}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
         \PY{n}{dataSubscribers}\PY{p}{,} \PY{n}{dataCustomers}\PY{p}{,} \PY{n}{avgSubscribers}\PY{p}{,} \PY{n}{avgCustomers} \PY{o}{=} \PY{n}{getDayDataByType}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{;}
         
         \PY{n}{dayList} \PY{o}{=} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{y\PYZus{}pos} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{dayList}\PY{p}{)}\PY{p}{)}\PY{p}{;}
         
         \PY{c+c1}{\PYZsh{} Subscriber}
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dataSubscribers}\PY{p}{,} \PY{n}{align}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dayList}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{} users}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Users during Week Days (Subscriber)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{avgSubscribers}\PY{p}{)}\PY{p}{;}
         \PY{n}{axes} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{gca}\PY{p}{(}\PY{p}{)}
         \PY{n}{axes}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{avgSubscribers}\PY{p}{)}\PY{p}{]}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dayList}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average duration (minutes)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average duration (minutes) during Week Days (Subscriber)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}\PY{p}{;}
         
         \PY{c+c1}{\PYZsh{} Customers}
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dataCustomers}\PY{p}{,} \PY{n}{align}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dayList}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{} users}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Users during Week Days (Customers)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{avgCustomers}\PY{p}{)}\PY{p}{;}
         \PY{n}{axes} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{gca}\PY{p}{(}\PY{p}{)}
         \PY{n}{axes}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{avgCustomers}\PY{p}{)}\PY{p}{]}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{dayList}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average duration (minutes)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average duration (minutes) during Week Days (Customer)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}\PY{p}{;}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
([7658, 8322, 8520, 8454, 7958, 5589, 5252], [1736, 1426, 1583, 1530, 2012, 3311, 2975], [12.30699903804299, 12.392428110229885, 12.564928616979662, 12.523436452172533, 12.171476185389961, 13.09449415816784, 12.95106167491746], [40.75283204685103, 41.77762893875646, 36.37025243209096, 39.68505344226579, 40.715874577534855, 44.58992639182527, 43.42934752380961])
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{k+kn}{from} \PY{n+nn}{subprocess} \PY{k}{import} \PY{n}{call}
